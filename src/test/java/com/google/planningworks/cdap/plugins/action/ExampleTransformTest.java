...
//  * the License.
//  */
// package org.example.hydrator.action;
//
...
//     AnaplanFunctionRunnerPlugin.Config config = new AnaplanFunctionRunnerPlugin.Config("SomeValue", null, INPUT.toString());
//     Transform<StructuredRecord, StructuredRecord> transform = new AnaplanFunctionRunnerPlugin(config);
